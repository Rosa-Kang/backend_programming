...
function animateMachine(animationDelay) {
    ...
    $('#sliders')
        .queue(function (next) {
            $(this).attr('src', 'https://content.codecademy.com/courses/learn-express-routes/sliders-active-1.svg');
            next();
        })
        .delay(animationDelay)
        .queue(function (next) {
            $(this).attr('src', 'https://content.codecademy.com/courses/learn-express-routes/sliders-active-2.svg');
            next();
        })
        .delay(animationDelay)
        .queue(function (next) {
        ...
        .delay(animationDelay)
        .queue(function (next) {
            $(this).attr('src', 'https://content.codecademy.com/courses/learn-express-routes/sliders-inactive.svg');
            next();
        });
    $('#buttons')
        .queue(function (next) {
            $(this).attr('src', 'https://content.codecademy.com/courses/learn-express-routes/buttons-active-1.svg');
            next();
        })
        .delay(animationDelay)
        .queue(function (next) {
            $(this).attr('src', 'https://content.codecademy.com/courses/learn-express-routes/buttons-active-2.svg');
            next();
        })
        .delay(animationDelay)
        .queue(function (next) {
        ...
        .delay(animationDelay)
        .queue(function (next) {
            $(this).attr('src', 'https://content.codecademy.com/courses/learn-express-routes/buttons-inactive.svg');
            next();
        });
}
